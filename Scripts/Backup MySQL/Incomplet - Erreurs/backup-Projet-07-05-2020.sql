...
INSERT INTO `cdr` VALUES ('CdR029384',46,'C187483'),('CdR102938',20,'C789987'),('CdR123321',40,'C123456'),('CdR241234',24,'C789987'),('CdR918274',120,'C198743');
...
INSERT INTO `produit` VALUES ('ail','légume','unite',50,25,100,'F1600'),('basilic','légume','g',5000,1200,7000,'F1600'),('beurre','matières grasses','g',600,200,1000,'F300'),('biscuit à la cuillère','biscuit','unite',50,20,100,'F200'),('boeuf haché','aliment','g',15000,10000,50000,'F200'),('cacao','poudre','g',2000,1000,5000,'F200'),('café','boisson','cl',5000,2000,10000,'F200'),('carotte','légume','unite',60,35,150,'F1600'),('chocolat','produits sucrés','bar',240,100,600,'F100'),('concombre','légume','unite',390,300,800,'F1600'),('courgette','légume','kg',30,10,100,'F200'),('crème fraîche','matières grasses','cup',30,20,70,'F1200'),('eau','boisson','L',15,10,30,'F1100'),('farine','produits céréaliers','g',15000,10000,60000,'F900'),('fromage râpé','aliment','g',1640,1000,3000,'F200'),('gruyère râpé','fromage','g',5000,2000,10000,'F200'),('huile','huiles','tbsp',240,150,350,'F400'),('lait','boisson','L',25,10,40,'F1100'),('lardon','aliment','g',2000,400,3000,'F400'),('laurier','légume','tbsp',35,30,50,'F1600'),('levure','aliment','g',1200,800,3000,'F900'),('mascarpone','fromage','g',50000,5000,80000,'F200'),('muscade','épice','tbsp',30,20,90,'F500'),('oeuf','aliment','unite',232,150,500,'F200'),('oignon','légume','unite',55,30,110,'F1600'),('pâte brisée','préparations pour pâtisseries','g',6000,1000,8000,'F1200'),('pâte de lasagne','aliment','g',2500,2000,8000,'F1400'),('poivre','épice','g',2000,800,3000,'F500'),('poivron','légume','unite',320,250,650,'F1600'),('pomme','fruit','unite',270,200,650,'F1600'),('purée de tomate','sauce','tbsp',250,150,500,'F600'),('saumon','poisson','kg',10,3,20,'F200'),('sel','sel','g',30000,15000,60000,'F500'),('sucre','sucre','g',50000,10000,100000,'F200'),('thym','épice','tbsp',42,20,60,'F500'),('tomate','fruit','unite',450,300,800,'F1600'),('vanille','épice','unite',50,10,150,'F200'),('vinaigre','vinaigre','tbsp',210,120,320,'F400');
...
-- Dump completed on 2020-05-08  7:42:41
